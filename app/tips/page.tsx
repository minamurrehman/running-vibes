...
import Tip1 from '@/app/assets/tip-1.png'
import Tip2 from '@/app/assets/tip-2.png'
...
const Home = () => {
  ...
  return (
    <div className='min-h-max mb-24 lg:mb-4'>
      ...
      />
      <DualImage imageA={Tip2} imageB={Tip1} className={'my-24'}>
        <h1 className='text-[40px] font-[600] max-w-[430px]'>
